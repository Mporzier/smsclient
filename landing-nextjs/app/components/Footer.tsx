      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 pb-8 border-b border-white/10">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            <h4 className="text-[#d1d5db] text-lg font-bold tracking-tight">
              SMS Client
            </h4>
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={text}
                  className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded border text-[11px] font-medium tracking-wide bg-[#121212] text-[#9ca3af] border-fuchsia-900/30 whitespace-nowrap"
                >
                  <span className="text-fuchsia-600/80 font-bold text-[10px]">
                    ✓
                  </span>
                  {text}
                </span>
          ...
          {/* Navigation Links */}
          <nav className="flex gap-x-8 gap-y-4 flex-wrap text-sm font-medium">
            {/* Primary Resources */}
            <Link
              href="/blog"
