          ...
          <div className="w-full max-w-[200px] bg-white rounded-xl shadow-xl p-3 relative z-10 border border-white/60">
            <div className="min-h-[120px] flex flex-col">
              <div className="flex bg-slate-100 p-0.5 rounded-lg mb-2">
                <div
                  className={`flex-1 text-[9px] font-bold py-1 rounded-md text-center transition-colors ${
                    phase !== "done"
                  ...
                  {statsVisible ? (
                    ...
                    >
                      <div className="relative w-14 h-14 mb-1 mx-auto">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center font-bold text-slate-800 text-xs">
                          98%
                        </div>
                      </div>
            ...
            <div className="mt-3 relative">
              <motion.div
                ...
                className={`
                                    ...
                                    ${
                                      phase === "done"
                                        ? "bg-amber-600 shadow-amber-700/30"
        ...
        <div className="p-4 bg-white border-t border-slate-50 text-left flex-shrink-0">
          <div className="flex items-center gap-2 mb-1.5">
            ...
            <h3 className="text-sm font-bold text-slate-900 tracking-tight">
              Envoi de SMS instantané ou programmé
            </h3>
          </div>
          <p className="text-slate-500 text-xs leading-relaxed">
            Envoyez vos campagnes SMS instantanément ou programmez leur envoi à
            l&apos;avance.{" "}
            <strong className="text-amber-900 font-semibold">
              98% de vos messages sont lus
            </strong>{" "}
