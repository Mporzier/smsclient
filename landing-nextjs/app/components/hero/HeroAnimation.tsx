  ...
  return (
    <div className="flex justify-center w-full h-full">
      <div
        ...
        style={{ fontSize: "clamp(1px, 0.75vw, 7.5px)" }}
      >
        <div
          style={
            {
        ...
        >
          <motion.div
            initial={{ opacity: 0, scale: 0.6, rotateY: -40, rotateX: 10, z: -300 }}
            animate={{ opacity: 1, scale: 1, rotateY: 0, rotateX: 0, z: 0 }}
            transition={{ duration: 1.4, ease: [0.16, 1, 0.3, 1], delay: 0.1 }}
            className="relative z-[1] aspect-[37/76] h-[70vh] bg-black rounded-[6.666em]"
            style={{
          ...
          >
            ...
            <div className="absolute inset-[-0.4em] pointer-events-none">
              <div className="absolute right-full top-[13.332em] flex flex-col gap-[1.5em] w-[0.333em]">
                <div className="h-[3em] rounded-l-[0.2em] bg-[hsl(var(--c-h),20%,95%)] shadow-[inset_-0.15em_0_0.1em_black,inset_0_0_0.1em_hsl(var(--c-h),30%,90%),inset_0_0.2em_0.1em_hsl(var(--c-h),30%,90%),inset_0_-0.2em_0.1em_hsl(var(--c-h),30%,90%),inset_-0.1em_0.333em_0.1em_rgba(0,0,0,0.5),inset_-0.1em_-0.333em_0.1em_rgba(0,0,0,0.5)]" />
                <div className="h-[6em] rounded-l-[0.2em] bg-[hsl(var(--c-h),20%,95%)] shadow-[inset_-0.15em_0_0.1em_black,inset_0_0_0.1em_hsl(var(--c-h),30%,90%),inset_0_0.2em_0.1em_hsl(var(--c-h),30%,90%),inset_0_-0.2em_0.1em_hsl(var(--c-h),30%,90%),inset_-0.1em_0.333em_0.1em_rgba(0,0,0,0.5),inset_-0.1em_-0.333em_0.1em_rgba(0,0,0,0.5)]" />
                <div className="h-[6em] rounded-l-[0.2em] bg-[hsl(var(--c-h),20%,95%)] shadow-[inset_-0.15em_0_0.1em_black,inset_0_0_0.1em_hsl(var(--c-h),30%,90%),inset_0_0.2em_0.1em_hsl(var(--c-h),30%,90%),inset_0_-0.2em_0.1em_hsl(var(--c-h),30%,90%),inset_-0.1em_0.333em_0.1em_rgba(0,0,0,0.5),inset_-0.1em_-0.333em_0.1em_rgba(0,0,0,0.5)]" />
              </div>
              <div className="absolute left-full top-[20em] w-[0.333em] scale-x-[-1]">
                <div className="h-[9.5em] rounded-l-[0.2em] bg-[hsl(var(--c-h),20%,95%)] shadow-[inset_-0.15em_0_0.1em_black,inset_0_0_0.1em_hsl(var(--c-h),30%,90%),inset_0_0.2em_0.1em_hsl(var(--c-h),30%,90%),inset_0_-0.2em_0.1em_hsl(var(--c-h),30%,90%),inset_-0.1em_0.333em_0.1em_rgba(0,0,0,0.5),inset_-0.1em_-0.333em_0.1em_rgba(0,0,0,0.5)]" />
              </div>
            </div>
            ...
            >
              ...
              <div
                className="absolute z-[20] top-[1.25em] right-[calc(50%-16.65%)] mr-[0.85em] mt-[0.85em] w-[1.6em] h-[1.6em] rounded-full flex items-center justify-center pointer-events-none"
                style={{
                  background:
