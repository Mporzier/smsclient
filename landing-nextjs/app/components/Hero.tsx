...
export default function Hero() {
  return (
    ...
    */
    <section className="py-20 px-4 max-w-[1440px] mx-auto min-h-screen flex items-center">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
        ...
        <div className="lg:col-span-7 flex flex-col items-center text-center lg:items-start mx-auto">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-slate-900 leading-[1.15]">
            Des SMS vus par
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center mx-auto">
            ...
            <button className="px-8 py-4 bg-transparent text-slate-700 border-2 border-slate-300 rounded-lg font-semibold text-xl hover:bg-slate-50 hover:border-slate-400 hover:text-slate-900 transition-all duration-300 w-full sm:w-auto">
